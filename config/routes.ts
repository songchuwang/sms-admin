export default [
  ...
  { path: '/welcome', name: '首页', icon: 'home', component: './Welcome' },
  {
    ...
    routes: [
      { path: '/enterpriseManage/enterpriseManage',access: 'platform:business:manager', name: '企业管理', component: './EnterpriseManage/EnterpriseManage' },
